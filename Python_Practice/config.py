...
groups = [
    ...
    Group('2', label="DEV", matches = [Match(wm_class = "Code")], layout='max'),
    Group('3', label="TERM", layout='monadtall'),
    Group('4', label="FILE", layout='monadtall'),
    Group('5', label="Chat", matches = [Match(wm_class = "discord"), Match(wm_class="TelegramDesktop")], layout='monadtall'),
    Group('6', label="ETC", matches = [Match(wm_class = "vysor")], layout='monadtall')
